...
// SCL -> PB6 SDA -> PB7
// SCL -> PE3 SDA -> PE2
#define SCL_PIN STM32F4_GPIO_PIN(4, 3)
#define SDA_PIN STM32F4_GPIO_PIN(4, 2)
void scl_high(){
...
char scl_read(){
	return stm32f4_gpio_get_input(SCL_PIN);
}
char sda_read(){
	return stm32f4_gpio_get_input(SDA_PIN);
}
void i2c_delay(){
...
#ifdef USE_I2C
#include <bsp/io.h>
stm32f4_gpio_config i2c_gpio_config =
{
	.fields={
...
stm32f4_gpio_set_config(&i2c_gpio_config);
i2c_config.fields.pin_first = STM32F4_GPIO_PIN(4, 2);
i2c_config.fields.pin_last = STM32F4_GPIO_PIN(4, 3);
i2c_config.fields.ospeed = STM32F4_GPIO_OSPEED_50_MHZ,
stm32f4_gpio_set_config(&i2c_gpio_config);
